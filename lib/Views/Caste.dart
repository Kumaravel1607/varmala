...
class Castes extends StatefulWidget {
  String index;
  Castes({required this.index});
  @override
  _CastesState createState() => _CastesState();
}

class _CastesState extends State<Castes> {
  ...
  _getuser() {
    _user = Service.getcaste(widget.index);
  }
